namespace BFGgameFinder.Data.Migrations
{
    ...
    public partial class TheOnesOne : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        ...
                        GamerTag = c.Guid(nullable: false),
                ...
                .ForeignKey("dbo.GameSystem", t => t.GameSystemId)
                ...
                c => new
                    {
                        ...
                        GameSystemType = c.String(nullable: false),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Game", "GameSystemId", "dbo.GameSystem");
            DropIndex("dbo.IdentityUserLogin", new[] { "ApplicationUser_Id" });
            DropIndex("dbo.IdentityUserClaim", new[] { "ApplicationUser_Id" });
            DropIndex("dbo.IdentityUserRole", new[] { "ApplicationUser_Id" });
            DropIndex("dbo.IdentityUserRole", new[] { "IdentityRole_Id" });
            DropIndex("dbo.Game", new[] { "GenreId" });
            DropIndex("dbo.Game", new[] { "GameSystemId" });
